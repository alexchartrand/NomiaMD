...
check the real, promoted file. Retrieval itself (a real, network-dependent llama_index/
Mistral call) is not exercised here — see scripts/ramq_vector_smoke_test.py."""
