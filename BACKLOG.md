...
- [ ] 🔴 `codes` LanceDB table covers only manual section B — *added 8/29, from billing_codes retrieval/prompt optimization*
...
- [ ] 🟡 Code-family disambiguating axes are free text, not typed columns — *added 8/29, from billing_codes retrieval/prompt optimization*
